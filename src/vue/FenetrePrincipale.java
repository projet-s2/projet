...
public class FenetrePrincipale extends JFrame {
	...
	//La fenÍtre principale ‡ un tournoi surlequel elle peut agir
	...
	public FenetrePrincipale(String titre, Tournoi leTournoi) {
		...
		//On charge le look and feel du systËme de l'utilisateur (‡ la place de GTK) auquel il est habituÈ
	    try {
		...
		//La notre choix avec liste deroulante et le bouton pour ajout√© le joueur et la combobox pour le sexe du joueur
		...
		joueurContent.add(new JButton("Ajout√© joueur"));
		...
		//Pareil que pour joueur, ajout√© le label a cote de la textBox
		...
		scoreContent.add(new JTextArea());
		scoreContent.add(new JButton("Ajout√© score"));
		...
		pairePourcent.add(new JLabel("Creation des paire non lanc√©"));
		paire.add(new JButton("Creation des paire"), BorderLayout.CENTER);
		paire.add(new JTextArea("Affichage des paire gener√©"), BorderLayout.WEST);
